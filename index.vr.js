...
export default class SolarSystem extends React.Component {
  ...
  rotate() {
    this.setState({
      ...
      angle2: this.state.angle2 + .0039,
      angle3: this.state.angle3 + .0035,
      angle4: this.state.angle4 + .0029,
      angle5: this.state.angle5 + .0025,
      angle6: this.state.angle6 + .0020,
      angle7: this.state.angle7 + .0018,
      angle8: this.state.angle8 + .0017,
    });
